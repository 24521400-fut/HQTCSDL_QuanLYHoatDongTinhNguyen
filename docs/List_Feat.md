...
6. **Ghi nhận hoạt động và giờ công:** Hệ thống tự động tính toán số giờ tích lũy dựa trên thời gian thực hiện công việc (từ lúc bắt đầu đến lúc kết thúc). Chỉ những tình nguyện viên có mặt mới được ghi nhận giờ công này.
...
13. **Thống kê số lượng chiến dịch và hiệu quả:** Cung cấp biểu đồ Dashboard trực quan, hiển thị so sánh Thu/Chi theo từng tuần của chiến dịch qua dạng cột nhóm, giúp đánh giá chính xác tiến độ giải ngân.
